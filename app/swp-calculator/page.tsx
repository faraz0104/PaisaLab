...
const CONTENT = (
  <>
    <h2>What is a SWP (Systematic Withdrawal Plan)?</h2>
    <p>A Systematic Withdrawal Plan (SWP) lets you withdraw a fixed amount from your mutual fund investment at regular intervals — monthly, quarterly, or annually. It works opposite to SIP: instead of depositing, you&apos;re withdrawing. SWP is popular among retirees who need regular income from their corpus.</p>
    <h2>How SWP Works</h2>
    <p>Your remaining corpus continues to earn returns even as you withdraw. If your returns exceed your withdrawal rate, your corpus can actually grow. The key metric is the &quot;safe withdrawal rate&quot; — the percentage of your corpus you can withdraw each year without depleting it.</p>
    <h2>Safe Withdrawal Rate</h2>
    <p>The globally accepted safe withdrawal rate is 4% per year (the &quot;4% rule&quot; by William Bengen). For Indian investors factoring in inflation and lower equity returns, 3–3.5% is more conservative. This means: for ₹10 crore corpus, you can safely withdraw ₹3–4 lakh/month indefinitely.</p>
  </>
);
...
export default function SWPPage() {
  return (
    <CalculatorShell
      ...
      content={CONTENT}
      relatedSlugs={["sip-calculator", "lumpsum-calculator", "fd-calculator"]}
    >
